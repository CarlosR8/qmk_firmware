 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | RGB  | GUI  | Alt  |Adjust|             |Raise | Song |Vol-/M| Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
...
_______ ,_______      ,_______      ,_______      ,_______      ,_______ ,_______ ,_______ ,TD(TD_SONG) ,TD(TD_MUTE)  ,KC_VOLU ,KC_MPLY   
),
